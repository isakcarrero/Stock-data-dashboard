...
/** The Datafetching class can be used to fetch data from the API and storing it in files.
 * It does not have any other functionality then that */
class Datafetching:
  ...
  def getStockData(ticker: String) =
    Try:
      ...
      /** if you dont have a folder already then this creates one */
